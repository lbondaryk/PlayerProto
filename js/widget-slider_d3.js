...
goog.provide('pearson.brix.SliderD3');
 ...
 * fields.
 **************************************************************************/
pearson.brix.SliderD3 = function (config, eventManager)
{
     ...
     * @type {string}
     */
    this.id = pearson.brix.utils.getIdFromConfigOrAuto(config, pearson.brix.SliderD3);
    ...
    this.lastdrawn =
        {
            ...
            /** @type {d3 slider object} */   sliderObj: null
        };
}; // end of slider constructor
goog.inherits(pearson.brix.SliderD3, pearson.brix.HtmlBric);
 ...
 * @type {string}
 */
pearson.brix.SliderD3.autoIdPrefix = "sldr_auto_";
 ...
 *
 ****************************************************************************/
pearson.brix.SliderD3.prototype.draw = function (container)
{   
    ...
    this.lastdrawn.sliderObj = d3.slider()
    ...
    var d3SliderDiv = widgetGroup.append('div')
        .attr('class', 'slider')
        .call(this.lastdrawn.sliderObj);
 ...
 ****************************************************************************/
pearson.brix.SliderD3.prototype.getValue = function ()
{
 ...
 ****************************************************************************/
pearson.brix.SliderD3.prototype.setValue = function (newValue)
{
    ...
    var slider = this.lastdrawn.sliderObj;
