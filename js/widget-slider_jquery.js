...
goog.provide('pearson.brix.SliderJQuery');
 ...
 * fields.
 **************************************************************************/
pearson.brix.SliderJQuery = function (config, eventManager)
{
     ...
     * @type {string}
     */
    this.id = pearson.brix.utils.getIdFromConfigOrAuto(config, pearson.brix.SliderJQuery);
...
goog.inherits(pearson.brix.SliderJQuery, pearson.brix.HtmlBric);
 ...
 * @type {string}
 */
pearson.brix.SliderJQuery.autoIdPrefix = "sldr_auto_";
 ...
 *
 ****************************************************************************/
pearson.brix.SliderJQuery.prototype.draw = function (container)
{   
 ...
 ****************************************************************************/
pearson.brix.SliderJQuery.prototype.getValue = function ()
{
 ...
 ****************************************************************************/
pearson.brix.SliderJQuery.prototype.setValue = function (newValue)
{
